//This variable keeps track iof who's turn it is.
let activePlayer = 'X';
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            activePlayer = 'O';
            //If the active player is anything other than 'X'.
        }
        else {
...
function checkWinConditions() {
    ...
    //This condition checks for a tie. If none of the above conditions register and
    //9 squares are selected the code executes.
    else if (selectedSquares.length >= 9) {
        //This function plays the tie game sound.
        audio('./media/choir.mp3');
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //If the 3 variables we passed are all included in our array then
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line indicates where the start of a line x is located.
    let x1 = coordX1,
        //This line indicates where the start of a line y is located.
        y1 = coordY1,
        //This line indicates where the end of a line x is located.
        x2 = coordX2,
        //This line indicates where the end of a line y is located.
        y2 = coordY2,
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y < y2) { y += 10; }
            //This condition cancels our animation loop if we've reached the endpoints.
